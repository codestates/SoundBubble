	...
	return (
		<>
			<div className="select-mode">
				{select === "piano" ? (
					<img className="piano" src={piano} onClick={e => handleBtnClick(e)} style={{ background: "red" }} />
				) : (
					<img className="piano" src={piano} onClick={e => handleBtnClick(e)} />
				)}
				{select === "mic" ? (
					<img className="mic" src={mic} onClick={e => handleBtnClick(e)} style={{ background: "red" }} />
				) : (
					<img className="mic" src={mic} onClick={e => handleBtnClick(e)} />
				)}
				{select === "upload" ? (
					<img className="upload" src={upload} onClick={e => handleBtnClick(e)} style={{ background: "red" }} />
				) : (
