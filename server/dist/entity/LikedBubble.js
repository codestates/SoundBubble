...
exports.LikedBubble = void 0;
const typeorm_1 = require("typeorm");
const User_1 = require("./User");
const Bubble_1 = require("./Bubble");
let LikedBubble = class LikedBubble extends typeorm_1.BaseEntity {
    id;
    createdAt;
    updatedAt;
    user;
...
], LikedBubble.prototype, "id", void 0);
__decorate([
    typeorm_1.CreateDateColumn({ name: "createdAt" }),
    __metadata("design:type", Date)
], LikedBubble.prototype, "createdAt", void 0);
__decorate([
...
__decorate([
    typeorm_1.ManyToOne(() => Bubble_1.Bubble, (bubble) => bubble.likedBubbles, { onDelete: "CASCADE" }),
